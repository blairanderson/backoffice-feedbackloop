function FrontOfHouse(firebaseRef, el, options) {
  var self = this;

  if (!firebaseRef) {
    throw new Error('FrontOfHouse: Missing required argument `firebaseRef`');
  }

  if (!el) {
    throw new Error('FrontOfHouse: Missing required argument `el`');
  }
...
// Run FrontOfHouse in *noConflict* mode, returning the `FrontOfHouse` variable to
// its previous owner, and returning a reference to the FrontOfHouse object.
FrontOfHouse.noConflict = function noConflict() {
  root.FrontOfHouse = previousFrontOfHouse;
  return FrontOfHouse;
};

FrontOfHouse.prototype = {
 ...
 */
FrontOfHouse.prototype.setUser = function(userId, userName) {
  var self = this;
 ...
 */
FrontOfHouse.prototype.on = function(eventType, cb) {
  var self = this;
 ...
 */
FrontOfHouse.prototype._bindSuperuserUIEvents = function() {
  var self = this,
 ...
 */
FrontOfHouse.prototype._bindForHeightChange = function() {
  var self = this,
      $el = $(this._el),
      lastHeight = null;
 ...
 */
FrontOfHouse.prototype._bindForTabControls = function() {
  var self = this;
 ...
 */
FrontOfHouse.prototype._bindForRoomList = function() {
  var self = this;
 ...
 */
FrontOfHouse.prototype._bindForUserRoomList = function() {
  var self = this;
 ...
 */
FrontOfHouse.prototype._bindForUserSearch = function() {
  var self = this,
 ...
 */
FrontOfHouse.prototype._bindForUserMuting = function() {
  var self = this;
 ...
 */
FrontOfHouse.prototype._bindForChatInvites = function() {
  var self = this,
 ...
 */
FrontOfHouse.prototype._bindForRoomListing = function() {
  var self = this,
 ...
 */
FrontOfHouse.prototype._setupTabs = function() {
  var self = this,
      show = function($el) {
        var $this = $el,
 ...
 */
FrontOfHouse.prototype._setupDropdowns = function() {
  var self = this,
 ...
 */
FrontOfHouse.prototype._bindTextInputFieldLimits = function() {
 ...
 */
FrontOfHouse.prototype.renderAlertPrompt = function(title, message) {
 ...
 */
FrontOfHouse.prototype.toggleInputs = function(isEnabled) {
 ...
 */
FrontOfHouse.prototype.attachTab = function(roomId, roomName) {
  var self = this;
 ...
 * @param    {string}    roomId
 */
FrontOfHouse.prototype.focusTab = function(roomId) {
  if (this.$messages[roomId]) {
 ...
 * @param    {string}    roomId
 */
FrontOfHouse.prototype.removeTab = function(roomId) {
 ...
 * @param    {string}    message
 */
FrontOfHouse.prototype.showMessage = function(roomId, rawMessage) {
  var self = this;
 ...
 */
FrontOfHouse.prototype.removeMessage = function(roomId, messageId) {
 ...
 */
FrontOfHouse.prototype.sortListLexicographically = function(selector) {
 ...
 * @return   {string}
 */
FrontOfHouse.prototype.trimWithEllipsis = function(str, length) {
 ...
 * @param    {string}    date
 */
FrontOfHouse.prototype.formatTime = function(timestamp) {
 ...
 */
FrontOfHouse.prototype.promptCreateRoom = function() {
  var self = this;
 ...
 */
FrontOfHouse.prototype.prompt = function(title, content) {
...
FrontOfHouse.prototype.linkify = function(str) {
  var self = this;
  return str
